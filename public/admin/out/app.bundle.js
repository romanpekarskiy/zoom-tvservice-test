...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChannelCollection = _backbone2.default.Collection.extend({
		model: _channel2.default,
		url: '/api/channels/'
	});
	
	exports.default = ChannelCollection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChannelModel = _backbone2.default.Model.extend({
		defaults: {
			title: 'untitled',
			location: ''
		},
